...
The graph above shows the average data value by state by year who responded that their over health was excellent. Although the rang of colors makes it hard to tell, it looks like DC usually had the highest average data value for this survey. WV seems to have the lowest average data values for this group as it is the redish line at the bottom of the graph.
...
The box plots above show the distribution of data values from NY during the years 2006 and 2010. Both years generally have the same distribution pattern, with the highest data values on average being in very good. Though based on the box plots, we can see that the maximum data value for 2006 was good and for 2010 it was very good. Also in 2010 there is a larger distribution of data values for fair and poor, and a smaller distribution for good than there was in 2006.
...
The table above clearly shows that the majority of the study participants have an education more than high school. The histograms above show the age range by gender and education. Here we can see that there are women in their 20-40 that have a education higher than high school than men. It also looks like this study recruited from a population of \~80 year old women of different educational background more than other groups. I can also clearly see that the more than high school section of the visual has the most participants
...
The plot above shows that MIM activity tends downward with age. However, for the high school equivalent group, there seems to be a trend upwards until around 40, then the MIM activity decreases. For the more than high school, MIM seems stable until around 50. For both high school equivalent and more than high school, female MIM activity tends to be higher
...
This plot clearly shows that as the day goes on, MIM activity increases and then decreases. It looks like the minimum (based on the graphs and no calculations) is around 250 minutes in all three graphs for both sexes. For the less than high school group, the peak is at around 750, with female higher than male. For the high school equivalent and more than high school there is more of a plateau around 500- 1250. Females are pretty consistently higher
